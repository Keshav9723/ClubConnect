package com.clubconnect.registrationservice.model;
...
public class Registration {
    ...
    public Registration(long id, long memberId, long eventId, LocalDateTime registrationDate, String status, String memberName, String eventName) {
        _Id = id;
        _MemberId = memberId;
        _EventId = eventId;
